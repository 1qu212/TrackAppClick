...
import cn.xydzjnq.track.api.TrackHelper;
...
public class ViewOnClickListenerAspectj {
    ...
    public void onViewClickAOP(final JoinPoint joinPoint) {
        ...
        TrackHelper.trackViewOnClick(view);
    }
     ...
     * @param joinPoint JoinPoint
     */
    @After("execution(@cn.xydzjnq.track.api.TrackViewOnClick * *(android.view.View))")
    ...
    public void onOptionsItemSelectedAOP(JoinPoint joinPoint) {
        ...
        TrackHelper.trackViewOnClick(joinPoint.getTarget(), view);
    }
    ...
    public void onDialogClickAOP(final JoinPoint joinPoint) {
        ...
        TrackHelper.trackViewOnClick(dialogInterface, which);
    }
    ...
    public void onDialogMultiChoiceClickAOP(final JoinPoint joinPoint) {
        ...
        TrackHelper.trackViewOnClick(dialogInterface, which, isChecked);
    }
    ...
    public void onCheckedChangedAOP(final JoinPoint joinPoint) {
        ...
        TrackHelper.trackViewOnClick(compoundButton, isChecked);
    }
    ...
    public void onItemSelectedAOP(final JoinPoint joinPoint) {
        ...
        TrackHelper.trackViewOnClick(adapterView, view, position);
    }
    ...
    public void onExpandableListViewChildClickAOP(final JoinPoint joinPoint) {
        ...
        TrackHelper.trackExpandableListViewChildOnClick(expandableListView, view, groupPosition, childPosition);
    }
    ...
    public void onExpandableListViewGroupClickAOP(final JoinPoint joinPoint) {
        ...
        View view = (View) joinPoint.getArgs()[1];
        int groupPosition = (int) joinPoint.getArgs()[2];
        TrackHelper.trackExpandableListViewChildOnClick(expandableListView, view, groupPosition, -1);
    }
}
